...
@RestController
@RequestMapping("/api") // the starting of URL is same to all the api's in the controller... 
...
//	@GetMapping("/api/public/categories") --- this is specific mapping 
//	@RequestMapping(value = "/api/public/categories", method = RequestMethod.GET) --- this is generic mapping 
